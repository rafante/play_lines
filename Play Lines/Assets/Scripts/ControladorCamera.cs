...
public class ControladorCamera : MonoBehaviour {
    ...
    void Update()
    {
		...
		} else if (Input.touchCount == 1) { //Se o jogador colocou um dedo na tela
		...
		} else if (Input.GetMouseButton (0)) { //Se estiver rodando mouse e tiver clicado com o botão esquerdo
